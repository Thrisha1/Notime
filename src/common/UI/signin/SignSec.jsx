  ...
  return (
    <section className="">
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <div class="w-full rounded-lg shadow border-0 md:mt-0 sm:max-w-md xl:p-0 bg-">
          <div class=" p-2 md:p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="#">
              ...
              <div class="flex items-center justify-between">
                ...
                <a
                  href="#"
                  class="text-sm font-medium text-p_red hover:underline text-primary-500"
                >
                  Forgot password?
                </a>
              </div>
              <button
                type="button"
                class="w-full border  text-white  hover:bg-p_red focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800"
              >
                Sign in
              </button>
