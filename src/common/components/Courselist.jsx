...
function Courselist({ name, img ,para }) {
  return (
    <div>
    <div id="coursebg" className="flex flex-col justify-center items-center sm:w-[200px] rounded-3xl bg-transparent  bg-opacity-[20%] ">
     ...
     <p class="font-montserrat text-[24px] font-semibold leading-29 tracking-wider ml-[4rem]  text-white  mb-[1rem]">{name}</p>
      ...
      <button className="text-blue text-[20px] sm:text-2xl  sm:tracking-[10px]  ml-[9rem] mt-[3rem] text-[#6366f1] ">REGISTER
          </button>
    </div>
    </div>
  );
